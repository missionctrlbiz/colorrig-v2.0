...
import StatsCTA from "@/components/common/cta/StatsCTA"
                            ...
                            <div className="row">
                                    ...
                                    <div className="service1-box-area" style={{ padding: '40px', borderRadius: '12px', height: '100%' }}>
                                        <div className="icons">
                                            <svg width={40} height={40} viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <circle cx={20} cy={20} r={18} stroke="#74fbfe" strokeWidth={2} />
                                                <circle cx={20} cy={20} r={10} stroke="#74fbfe" strokeWidth={2} />
                                                <circle cx={20} cy={20} r={3} fill="#74fbfe" />
                                            </svg>
                                        </div>
                                        <div className="space20" />
                                        <h4>Our Mission</h4>
                                ...
                                <div className="col-lg-6" data-aos="fade-up" data-aos-duration={1000}>
                                    ...
                                    <div className="service1-box-area" style={{ padding: '40px', borderRadius: '12px', height: '100%' }}>
                                        <div className="icons">
                                            <svg width={40} height={40} viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M20 4L24 16H36L26 24L30 36L20 28L10 36L14 24L4 16H16L20 4Z" stroke="#74fbfe" strokeWidth={2} fill="none" />
                                            </svg>
                                        </div>
                                        <div className="space20" />
                                        <h4>Our Vision</h4>
                        ...
                        <div className="container">
                            ...
                            <div className="row">
                                <div className="col-lg-4 col-md-6" data-aos="fade-up" data-aos-duration={800}>
                                    <div className="service1-box-area" style={{ padding: '30px', borderRadius: '12px', marginBottom: '24px' }}>
