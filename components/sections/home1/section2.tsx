					...
					<div className="row align-items-center">
						<div className="col-lg-6">
							<div className="about-imges">
								<div className="img1 reveal image-anime">
									<img src="/images/colorrig-1.jpg" alt="" style={{ borderRadius: '10px' }} />
								</div>
								<div className="row">
									<div className="col-lg-6 col-md-6">
										<div className="space30" />
										<div className="img1 reveal image-anime">
											<img src="/images/colorrig-2.jpg" alt="" style={{ borderRadius: '10px' }} />
										</div>
									</div>
									<div className="col-lg-6 col-md-6">
										<div className="space30" />
										<div className="img1 reveal image-anime">
											<img src="/images/colorrig-3.jpg" alt="" style={{ borderRadius: '10px' }} />
										</div>
									</div>
								</div>
						...
						<div className="col-lg-6">
							<div className="about-header-area heading2">
								...
								<div className="space16" />
								<p data-aos="fade-left" data-aos-duration={900}>Colorrig Limited is your gateway to unforgettable events. From concept to execution, we create immersive experiences that captivate audiences and elevate your brand.</p>
								<div className="space32" />
								<div className="about-auhtor-box" data-aos="fade-left" data-aos-duration={1000}>
									<div className="icons about-icon-custom">
										<i className="fa-solid fa-lightbulb" />
									</div>
									<div className="text">
										<Link href="/#" className="about-link">Driven by Innovation</Link>
										<div className="space12" />
										<p>With a passionate team of event experts and cutting-edge technology.</p>
									</div>
								</div>
								...
								<div className="about-auhtor-box" data-aos="fade-left" data-aos-duration={1100}>
									...
									<div className="text">
										<Link href="/#" className="about-link">Commitment to Excellence</Link>
										<div className="space12" />
										<p>We deliver exceptional results that leave a lasting impact on your audience.</p>
									</div>
								</div>
								<div className="space32" />
								<div className="btn-area1" data-aos="fade-left" data-aos-duration={1200}>
									<Link href="/about" className="vl-btn1">Read Our Story</Link>
								</div>
							</div>
						</div>
					</div>
